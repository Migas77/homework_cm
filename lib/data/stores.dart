...
List<Store> stores = [
  Store(
      ...
      mealType: "Mercearia",
      top3Highlights: [h_quality_price_racio, h_delicious_food, h_friendly_staff],
  ...
  Store(
      ...
      mealType: "Jantar",
      top3Highlights: [h_quality_price_racio, h_good_quantity, h_fast_retrieval],
  ...
  Store(
      ...
      mealType: "Refeição",
      top3Highlights: [h_quality_price_racio, h_friendly_staff, h_delicious_food],
      availableSurpriseBags: 4,
